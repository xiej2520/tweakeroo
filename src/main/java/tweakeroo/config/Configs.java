...
public class Configs
{
    ...
    public static class Generic
    {
        ...
        public static final DoubleConfig  FLY_DECELERATION_FACTOR               = new DoubleConfig( "flyDecelerationFactor", 0.4, 0.0, 1.0);
        ...
        public static final DoubleConfig  FLY_SPEED_PRESET_5                    = new DoubleConfig( "flySpeedPreset5", 0.64, 0.0, 4.0);
        public static final DoubleConfig  FLY_SPEED_PRESET_6                    = new DoubleConfig( "flySpeedPreset6", 0.96, 0.0, 4.0);
