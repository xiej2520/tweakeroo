...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_BREAK_REPLACE             ("tweakBreakReplace",                   false, "",    "When enabled, you immediately replace blocks after you break them.\nUseful for placing on air."),
    ...
    TWEAK_ENDER_PEARL_CHUNK_LOADING ("tweakEnderPearlChunkLoading",         false, true, "", "Allows horizontally moving Ender Pearls to load chunks as Entity Ticking"),
    ...
    TWEAK_MATCHING_SKY_FOG          ("tweakMatchingSkyFog",                 false, "",    "If enabled, then the overworld fog matches the sky color,\ngiving a much nicer continuous sky look, especially if the\nrender distance fog is disabled."),
    ...
    TWEAK_OUTLINE_ENTITIES          ("tweakOutlineEntities",                false, "",    "If enabled, all entities are outlined.\nApplies to entities immune to the glowing effect."),
